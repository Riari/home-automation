...
use App\Phase\Admin\DisableSleepEvents;
use App\Phase\Admin\EnableSleepEvents;
...
$r->addRoute('POST', '/admin/events/sleep/enable', [Authenticate::class, EnableSleepEvents::class]);
$r->addRoute('POST', '/admin/events/sleep/disable', [Authenticate::class, DisableSleepEvents::class]);
